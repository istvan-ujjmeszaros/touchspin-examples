...
const tailwindCoreOptions = {
  ...
  buttonup_class:
    'px-3 py-2 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold border-0 transition-colors duration-150 rounded-none first:rounded-l-xl last:rounded-r-xl',
  buttondown_class:
    'px-3 py-2 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold border-0 transition-colors duration-150 rounded-none first:rounded-l-xl last:rounded-r-xl',
  prefix_extraclass:
